...
module.exports = {
  up: async (queryInterface, Sequelize) => {
    return queryInterface.bulkInsert('contest', [{
      ...
      id_provider: 2,
      prize: "5000000",
      due_date: new Date("2021-01-21 00:00:00"),
      ...
      id_status_contest: 1,
      announcement: new Date("2021-01-23 00:00:00"),
      createdAt: new Date(),
      updatedAt: new Date(),
    }, {
      ...
      id_provider: 2,
      prize: "10000000",
      due_date: new Date("2021-03-28 00:00:00"),
      ...
      id_status_contest: 2,
      announcement: new Date("2021-03-30 00:00:00"),
      createdAt: new Date(),
      updatedAt: new Date(),
    }, {
      ...
      id_provider: 2,
      prize: "12000000",
      due_date: new Date ("2021-04-05 00:00:00"),
      ...
      id_status_contest: 2,
      announcement: new Date("2021-04-07 00:00:00"),
      createdAt: new Date(),
      updatedAt: new Date(),
    }, {
      ...
      id_provider: 2,
      prize: "15000000",
      due_date: new Date("2021-04-01 00:00:00"),
      ...
      id_status_contest: 1,
      announcement: new Date("2021-04-03 00:00:00"),
      createdAt: new Date(),
      updatedAt: new Date(),
    }, {
      ...
      id_provider: 3,
      prize: "12000000",
      due_date: new Date("2021-03-21 00:00:00"),
      ...
      id_status_contest: 1,
      announcement: new Date("2021-03-23 00:00:00"),
      createdAt: new Date(),
      updatedAt: new Date(),
    }, {
      title: "Insurants",
      ...
      id_provider: 4,
      prize: "5000000",
      due_date: new Date("2021-01-05 00:00:00"),
      ...
      id_status_contest: 2,
      announcement: new Date("2021-01-07 00:00:00"),
      createdAt: new Date(),
      updatedAt: new Date(),
    }, {
      ...
      id_provider: 4,
      prize: "10000000",
      due_date: new Date("2021-03-01 00:00:00"),
      ...
      id_status_contest: 1,
      announcement: new Date("2021-03-03 00:00:00"),
      createdAt: new Date(),
      updatedAt: new Date(),
    }, {
      ...
      id_provider: 4,
      prize: "12000000",
      due_date: new Date("2021-03-05 00:00:00"),
      description: "We are mortgage lenders. Our target audience are homeowners.",
      id_status_contest: 2,
      announcement: new Date("2021-03-07 00:00:00"),
      createdAt: new Date(),
      updatedAt: new Date(),
    }, {
      ...
      id_provider: 5,
      prize: "20000000",
      due_date: new Date("2021-03-09 00:00:00"),
      description: "Apartment homes in in a down town setting advertised as luxury for a sophisticated client.",
      id_status_contest: 1,
      announcement: new Date("2021-03-12 00:00:00"),
      createdAt: new Date(),
      updatedAt: new Date(),
    }])
  },
